...
const (
	...
	SDL_APP_TERMINATING = iota /**< The application is being terminated by the OS
	  Called on iOS in applicationWillTerminate()
	  Called on Android in onDestroy()
	*/
	SDL_APP_LOWMEMORY = iota /**< The application is low on memory, free memory if possible.
	  Called on iOS in applicationDidReceiveMemoryWarning()
	  Called on Android in onLowMemory()
	*/
	SDL_APP_WILLENTERBACKGROUND = iota /**< The application is about to enter the background
	  Called on iOS in applicationWillResignActive()
	  Called on Android in onPause()
	*/
	SDL_APP_DIDENTERBACKGROUND = iota /**< The application did enter the background and may not get CPU for some time
	  Called on iOS in applicationDidEnterBackground()
	  Called on Android in onPause()
	*/
	SDL_APP_WILLENTERFOREGROUND = iota /**< The application is about to enter the foreground
	  Called on iOS in applicationWillEnterForeground()
	  Called on Android in onResume()
	*/
	SDL_APP_DIDENTERFOREGROUND = iota /**< The application is now interactive
	  Called on iOS in applicationDidBecomeActive()
	  Called on Android in onResume()
	*/

	SDL_LOCALECHANGED = iota /**< The user's locale preferences have changed. */
	...
	SDL_SYSWMEVENT  = iota  /**< System specific event */

	/* Keyboard events */
	SDL_KEYDOWN       = 0x300 /**< Key pressed */
	SDL_KEYUP         = iota  /**< Key released */
	SDL_TEXTEDITING   = iota  /**< Keyboard text editing (composition) */
	SDL_TEXTINPUT     = iota  /**< Keyboard text input */
	SDL_KEYMAPCHANGED = iota  /**< Keymap changed due to a system event such as an
	  input language or keyboard layout change.
	*/

	/* Mouse events */
	SDL_MOUSEMOTION     = 0x400 /**< Mouse moved */
	SDL_MOUSEBUTTONDOWN = iota  /**< Mouse button pressed */
	SDL_MOUSEBUTTONUP   = iota  /**< Mouse button released */
	SDL_MOUSEWHEEL      = iota  /**< Mouse wheel motion */

	/* Joystick events */
	SDL_JOYAXISMOTION    = 0x600 /**< Joystick axis motion */
	SDL_JOYBALLMOTION    = iota  /**< Joystick trackball motion */
	SDL_JOYHATMOTION     = iota  /**< Joystick hat position change */
	SDL_JOYBUTTONDOWN    = iota  /**< Joystick button pressed */
	SDL_JOYBUTTONUP      = iota  /**< Joystick button released */
	SDL_JOYDEVICEADDED   = iota  /**< A new joystick has been inserted into the system */
	SDL_JOYDEVICEREMOVED = iota  /**< An opened joystick has been removed */

	/* Game controller events */
	SDL_CONTROLLERAXISMOTION     = 0x650 /**< Game controller axis motion */
	SDL_CONTROLLERBUTTONDOWN     = iota  /**< Game controller button pressed */
	SDL_CONTROLLERBUTTONUP       = iota  /**< Game controller button released */
	SDL_CONTROLLERDEVICEADDED    = iota  /**< A new Game controller has been inserted into the system */
	SDL_CONTROLLERDEVICEREMOVED  = iota  /**< An opened Game controller has been removed */
	SDL_CONTROLLERDEVICEREMAPPED = iota  /**< The controller mapping was updated */
	SDL_CONTROLLERTOUCHPADDOWN   = iota  /**< Game controller touchpad was touched */
	SDL_CONTROLLERTOUCHPADMOTION = iota  /**< Game controller touchpad finger was moved */
	SDL_CONTROLLERTOUCHPADUP     = iota  /**< Game controller touchpad finger was lifted */
	SDL_CONTROLLERSENSORUPDATE   = iota  /**< Game controller sensor was updated */

	/* Touch events */
	SDL_FINGERDOWN   = 0x700
	SDL_FINGERUP     = iota
	SDL_FINGERMOTION = iota

	/* Gesture events */
	SDL_DOLLARGESTURE = 0x800
	SDL_DOLLARRECORD  = iota
	SDL_MULTIGESTURE  = iota
	...
	SDL_DROPTEXT     = iota   /**< text/plain drag-and-drop event */
	SDL_DROPBEGIN    = iota   /**< A new set of drops is beginning (NULL filename) */
	SDL_DROPCOMPLETE = iota   /**< Current set of drops is now complete (NULL filename) */

	/* Audio hotplug events */
	SDL_AUDIODEVICEADDED   = 0x1100 /**< A new audio device is available */
	SDL_AUDIODEVICEREMOVED = iota   /**< An audio device has been removed. */
	...
	SDL_RENDER_DEVICE_RESET  = iota   /**< The device has been reset and all textures need to be recreated */
