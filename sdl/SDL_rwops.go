...
//const char *mode);
func SDL_RWFromFile(file common.FConstCharP, mode common.FConstCharP) {
...
func SDL_FreeRW(area *SDL_RWops) (res *SDL_RWops) {
...
func (context *SDL_RWops) SDL_RWsize() (res common.FInt64T) {
...
func (context *SDL_RWops) SDL_RWseek(offset common.FInt64T, whence common.FInt) (res common.FInt64T) {
...
func (context *SDL_RWops) SDL_RWtell() (res common.FInt64T) {
