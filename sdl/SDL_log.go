...
const (
	...
	SDL_LOG_CATEGORY_ERROR       = iota
	SDL_LOG_CATEGORY_ASSERT      = iota
	SDL_LOG_CATEGORY_SYSTEM      = iota
	SDL_LOG_CATEGORY_AUDIO       = iota
	SDL_LOG_CATEGORY_VIDEO       = iota
	SDL_LOG_CATEGORY_RENDER      = iota
	SDL_LOG_CATEGORY_INPUT       = iota
	SDL_LOG_CATEGORY_TEST        = iota

	/* Reserved for future SDL library use */
	SDL_LOG_CATEGORY_RESERVED1  = iota
	SDL_LOG_CATEGORY_RESERVED2  = iota
	SDL_LOG_CATEGORY_RESERVED3  = iota
	SDL_LOG_CATEGORY_RESERVED4  = iota
	SDL_LOG_CATEGORY_RESERVED5  = iota
	SDL_LOG_CATEGORY_RESERVED6  = iota
	SDL_LOG_CATEGORY_RESERVED7  = iota
	SDL_LOG_CATEGORY_RESERVED8  = iota
	SDL_LOG_CATEGORY_RESERVED9  = iota
	SDL_LOG_CATEGORY_RESERVED10 = iota
...
const (
	...
	SDL_LOG_PRIORITY_DEBUG    = iota
	SDL_LOG_PRIORITY_INFO     = iota
	SDL_LOG_PRIORITY_WARN     = iota
	SDL_LOG_PRIORITY_ERROR    = iota
	SDL_LOG_PRIORITY_CRITICAL = iota
	SDL_NUM_LOG_PRIORITIES    = iota
)
