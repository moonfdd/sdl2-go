...
const (
	...
	SDL_POWERSTATE_ON_BATTERY = iota /**< Not plugged in, running on the battery */
	SDL_POWERSTATE_NO_BATTERY = iota /**< Plugged in, no battery available */
	SDL_POWERSTATE_CHARGING   = iota /**< Plugged in, charging battery */
	SDL_POWERSTATE_CHARGED    = iota /**< Plugged in, battery charged */
)
