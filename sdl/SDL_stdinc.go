...
type SDL_free_func = *func(mem common.FVoidP)
...
func SDL_GetMemoryFunctions(malloc_func SDL_malloc_func,
	...
	t, _, _ := common.GetSDL2Dll().NewProc("SDL_GetMemoryFunctions").Call(
		uintptr(unsafe.Pointer(malloc_func)),
		uintptr(unsafe.Pointer(calloc_func)),
		uintptr(unsafe.Pointer(realloc_func)),
...
func SDL_qsort(base common.FVoidP, nmemb common.FSizeT, size common.FSizeT, compare *func(common.FConstVoidP, common.FConstVoidP) common.FInt) {
