...
const (
	...
	SDL_JOYSTICK_TYPE_GAMECONTROLLER = iota
	SDL_JOYSTICK_TYPE_WHEEL          = iota
	SDL_JOYSTICK_TYPE_ARCADE_STICK   = iota
	SDL_JOYSTICK_TYPE_FLIGHT_STICK   = iota
	SDL_JOYSTICK_TYPE_DANCE_PAD      = iota
	SDL_JOYSTICK_TYPE_GUITAR         = iota
	SDL_JOYSTICK_TYPE_DRUM_KIT       = iota
	SDL_JOYSTICK_TYPE_ARCADE_PAD     = iota
	SDL_JOYSTICK_TYPE_THROTTLE       = iota
)
...
const (
	...
	SDL_JOYSTICK_POWER_EMPTY   = iota /* <= 5% */
	SDL_JOYSTICK_POWER_LOW     = iota /* <= 20% */
	SDL_JOYSTICK_POWER_MEDIUM  = iota /* <= 70% */
	SDL_JOYSTICK_POWER_FULL    = iota /* <= 100% */
	SDL_JOYSTICK_POWER_WIRED   = iota
	SDL_JOYSTICK_POWER_MAX     = iota
)
