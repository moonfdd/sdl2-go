...
//unsigned int *pCount,
//const char **pNames);
func (window *SDL_Window) SDL_Vulkan_GetInstanceExtensions(pCount *ffcommon.FUnsignedInt,
...
//int *w, int *h);
func (window *SDL_Window) SDL_Vulkan_GetDrawableSize(w *ffcommon.FInt, h *ffcommon.FInt) {
