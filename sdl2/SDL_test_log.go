...
func SDLTest_Log(fmt0 ffcommon.FConstCharP, a ...[]uintptr) {
	t, _, _ := sdlcommon.GetSDL2Dll().NewProc("SDLTest_Log").Call(
		uintptr(unsafe.Pointer(ffcommon.BytePtrFromString(fmt0))),
...
func SDLTest_LogError(fmt0 ffcommon.FConstCharP, a ...[]uintptr) {
