...
//const SDL_Rect * clip,
//SDL_Rect * result);
func (points *SDL_Point) SDL_EnclosePoints(count ffcommon.FInt,
	clip *SDL_Rect,
...
//int *Y1, int *X2,
//int *Y2);
func (rect *SDL_Rect) SDL_IntersectRectAndLine(X1 *ffcommon.FInt,
	Y1 *ffcommon.FInt, X2 *ffcommon.FInt,
	Y2 *ffcommon.FInt) (res bool) {
