 ...
 *  This hint must be set before calling SDL_Init(SDL_INIT_GAMEPAD)
 */
const SDL_HINT_JOYSTICK_HIDAPI_VERTICAL_JOY_CONS = "SDL_JOYSTICK_HIDAPI_VERTICAL_JOY_CONS"
 ...
 *    "1"       - player LEDs are enabled (the default)
 */
const SDL_HINT_JOYSTICK_HIDAPI_WII_PLAYER_LED = "SDL_JOYSTICK_HIDAPI_WII_PLAYER_LED"
 ...
 *    "1"       - player LEDs are enabled (the default)
 */
const SDL_HINT_JOYSTICK_HIDAPI_XBOX_360_PLAYER_LED = "SDL_JOYSTICK_HIDAPI_XBOX_360_PLAYER_LED"
 ...
 */
const SDL_HINT_JOYSTICK_HIDAPI_XBOX_360_WIRELESS = "SDL_JOYSTICK_HIDAPI_XBOX_360_WIRELESS"
 ...
 */
const SDL_HINT_JOYSTICK_HIDAPI_XBOX_ONE_HOME_LED = "SDL_JOYSTICK_HIDAPI_XBOX_ONE_HOME_LED"
 ...
 * fails.
 */
const SDL_HINT_VIDEO_EGL_ALLOW_GETDISPLAY_FALLBACK = "SDL_VIDEO_EGL_GETDISPLAY_FALLBACK"
 ...
 *  mode directly.
 */
const SDL_HINT_VIDEO_WAYLAND_EMULATE_MOUSE_WARP = "SDL_VIDEO_WAYLAND_EMULATE_MOUSE_WARP"
 ...
 */
const SDL_HINT_WINDOWS_ENABLE_MENU_MNEMONICS = "SDL_WINDOWS_ENABLE_MENU_MNEMONICS"
...
func SDL_ResetHint(name sdlcommon.FConstCharP) (res bool) {
	t, _, _ := sdlcommon.GetSDL2Dll().NewProc("SDL_ResetHint").Call(
		sdlcommon.UintPtrFromString(name),
	)
	res = sdlcommon.GoBool(t)
	return
...
func SDL_ResetHints() {
	sdlcommon.GetSDL2Dll().NewProc("SDL_ResetHints").Call()
}
...
//                                                 void *userdata);
func SDL_AddHintCallback(name sdlcommon.FConstCharP, callback SDL_HintCallback, userdata sdlcommon.FVoidP) (res sdlcommon.FInt) {
...
func SDL_DelHintCallback(name sdlcommon.FConstCharP, callback SDL_HintCallback, userdata sdlcommon.FVoidP) {
	sdlcommon.GetSDL2Dll().NewProc("SDL_DelHintCallback").Call(
		sdlcommon.UintPtrFromString(name),
		sdlcommon.NewCallback(callback),
		userdata,
	)
...
func SDL_ClearHints() {
	sdlcommon.GetSDL2Dll().NewProc("SDL_ClearHints").Call()
}
