...
func SDL_ResetHint(name ffcommon.FConstCharP) (res bool) {
...
//                                                 void *userdata);
func SDL_AddHintCallback(name ffcommon.FConstCharP, callback SDL_HintCallback, userdata ffcommon.FVoidP) (res ffcommon.FInt) {
