...
const (
	SDL_SENSOR_INVALID = -1 + iota /**< Returned for an invalid sensor */
...
func SDL_GetSensors(count *ffcommon.FInt) (res *SDL_SensorID) {
	...
	res = (*SDL_SensorID)(unsafe.Pointer(t))
	return
}
...
func SDL_GetSensorInstanceType(instance_id SDL_SensorID) (res SDL_SensorType) {
	t, _, _ := sdlcommon.GetSDL2Dll().NewProc("SDL_GetSensorInstanceType").Call(
		uintptr(instance_id),
	)
...
func SDL_OpenSensor(instance_id SDL_SensorID) (res *SDL_Sensor) {
	t, _, _ := sdlcommon.GetSDL2Dll().NewProc("SDL_OpenSensor").Call(
		uintptr(instance_id),
	)
...
func SDL_GetSensorFromInstanceID(instance_id SDL_SensorID) (res *SDL_Sensor) {
	t, _, _ := sdlcommon.GetSDL2Dll().NewProc("SDL_GetSensorFromInstanceID").Call(
		uintptr(instance_id),
	)
	res = (*SDL_Sensor)(unsafe.Pointer(t))
	return
...
func (sensor *SDL_Sensor) SDL_GetSensorType() (res SDL_SensorType) {
	t, _, _ := sdlcommon.GetSDL2Dll().NewProc("SDL_GetSensorType").Call(
		uintptr(unsafe.Pointer(sensor)),
	)
	res = SDL_SensorType(t)
	return
...
func (sensor *SDL_Sensor) SDL_GetSensorInstanceID() (res SDL_SensorID) {
	t, _, _ := sdlcommon.GetSDL2Dll().NewProc("SDL_GetSensorInstanceID").Call(
		uintptr(unsafe.Pointer(sensor)),
	)
	res = SDL_SensorID(t)
	return
...
func (sensor *SDL_Sensor) SDL_CloseSensor() {
	sdlcommon.GetSDL2Dll().NewProc("SDL_CloseSensor").Call(
		uintptr(unsafe.Pointer(sensor)),
	)
}
...
func (sensor *SDL_Sensor) SDL_UpdateSensors() {
	sdlcommon.GetSDL2Dll().NewProc("SDL_UpdateSensors").Call(
		uintptr(unsafe.Pointer(sensor)),
	)
}
