...
type SDL_SpinLock ffcommon.FInt
...
func (lock *SDL_SpinLock) SDL_AtomicLock() {
	sdlcommon.GetSDL2Dll().NewProc("SDL_AtomicLock").Call(
		uintptr(unsafe.Pointer(lock)),
	)
}
...
func (lock *SDL_SpinLock) SDL_AtomicUnlock() {
	sdlcommon.GetSDL2Dll().NewProc("SDL_AtomicUnlock").Call(
		uintptr(unsafe.Pointer(lock)),
	)
}
...
func SDL_MemoryBarrierReleaseFunction() {
	sdlcommon.GetSDL2Dll().NewProc("SDL_MemoryBarrierReleaseFunction").Call()
	return
}

// extern DECLSPEC void SDLCALL SDL_MemoryBarrierAcquireFunction(void);
func SDL_MemoryBarrierAcquireFunction() {
	sdlcommon.GetSDL2Dll().NewProc("SDL_MemoryBarrierAcquireFunction").Call()
}
...
func (a *SDL_atomic_t) SDL_AtomicCAS(oldval ffcommon.FInt, newval ffcommon.FInt) (res bool) {
...
func (a *SDL_atomic_t) SDL_AtomicSet(v ffcommon.FInt) (res ffcommon.FInt) {
...
func (a *SDL_atomic_t) SDL_AtomicGet() (res ffcommon.FInt) {
...
func (a *SDL_atomic_t) SDL_AtomicAdd(v ffcommon.FInt) (res ffcommon.FInt) {
...
func SDL_AtomicCASPtr(a *ffcommon.FVoidP, oldval, newval ffcommon.FVoidP) (res bool) {
...
func SDL_AtomicSetPtr(a *ffcommon.FVoidP, v ffcommon.FVoidP) (res ffcommon.FVoidP) {
...
func SDL_AtomicGetPtr(a *ffcommon.FVoidP) (res ffcommon.FVoidP) {
